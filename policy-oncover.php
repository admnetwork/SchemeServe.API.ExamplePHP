	...
	<body> 
		<div id="outerContainer">
			<div id="innerContainer">
				...
				<span class="DEBUG">
					<ul>
						<li>The text section must always appear. If there is no text available in the special system document 'Policy CoverSummary', use the copy provided here.</li>
					</ul>
				</span>
				<div id="mainContent">					
					<h1>Success!</h1>
					...
					<div class="edgy">
						<h3>Your insurance policy is now active.</h3>
						...
						<h3>IMPORTANT: You policy reference is CASE_ID.</h3>
